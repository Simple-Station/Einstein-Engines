...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_auth_callback_t
    {
        ...
        internal delegate* unmanaged<cef_auth_callback_t*, cef_string_t*, cef_string_t*, void> _cont;
        internal delegate* unmanaged<cef_auth_callback_t*, void> _cancel;
        ...
        {
            self->_cont(self, username, password);
        }
