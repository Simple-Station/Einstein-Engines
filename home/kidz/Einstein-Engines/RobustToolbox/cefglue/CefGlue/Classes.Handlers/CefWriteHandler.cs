namespace Xilium.CefGlue
{
    ...
    {
        internal UIntPtr write(cef_write_handler_t* self, void* ptr, UIntPtr size, UIntPtr n)
        {
            CheckSelf(self);
        ...
        internal int seek(cef_write_handler_t* self, long offset, int whence)
        {
            CheckSelf(self);
        ...
        internal long tell(cef_write_handler_t* self)
        {
            CheckSelf(self);
        ...
        internal int flush(cef_write_handler_t* self)
        {
            CheckSelf(self);
        ...
        internal int may_block(cef_write_handler_t* self)
        {
            CheckSelf(self);
