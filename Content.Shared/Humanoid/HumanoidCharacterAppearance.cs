...
namespace Content.Shared.Humanoid
{
    ...
    public sealed partial class HumanoidCharacterAppearance : ICharacterAppearance
    {
        ...
        public static HumanoidCharacterAppearance Random(string species, Sex sex)
        {
            ...
            var skinTone = IoCManager.Resolve<IPrototypeManager>().Index<SpeciesPrototype>(species).DefaultSkinTone; //, required for tone blending
            ...
            if (skinType == HumanoidSkinColor.TintedHuesSkin) //, tone blending
            {
