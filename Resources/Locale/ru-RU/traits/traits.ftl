...
trait-will-to-live-desc = Добавляет живучести, позволяя дольше не умирать в «крите».
trait-tenacity-name = Стойкость
trait-tenacity-desc = Ваш организм обладает невероятной волей к жизни. Вы способны оставаться в сознании даже после травм, которые отправили бы обычного человека в глубокий нокаут.
trait-glass-jaw-name = Хрустальная челюсть
trait-glass-jaw-desc = Один точный удар в подбородок — и для вас гаснет свет. Ваша физиология делает вас крайне чувствительным к шоку и боли.
trait-temperature-tolerance-name = Терморегуляция
trait-temperature-tolerance-desc = Ваше тело невероятно эффективно адаптируется к экстремальным температурам. Ледяной вакуум или жар горящего отсека для вас — лишь повод надеть футболку полегче.
trait-redshirt-name = Красная рубашка
trait-redshirt-desc = Судьба явно не на вашей стороне. Ваша физиология настолько хрупка, что любая травма, доводящая вас до критического состояния, становится фатальной мгновенно.
