...
ent-CrateEngineeringTEGKit = ящик сборки ТЭГа
    .desc = Набор 'построй свой собственный ТЭГ сам'. Потребуется мультитул.
ent-CrateEngineeringSupermatterCrate = ящик суперматерии
    .desc = Коробка с упакованной суперматерией. Будьте осторожны!
