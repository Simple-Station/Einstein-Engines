...
ent-EncryptionKeyCargo = logistics encryption key
...
ent-EncryptionKeyMedicalScience = med-epi encryption key
    .desc = An encryption key used by someone who hasn't decided which side to take.
ent-EncryptionKeyScience = epistemics encryption key
