...
# Mass Sleep
mass-sleep-power-description = Put targets to sleep in a small area.
...
# Mind Swap
mind-swap-power-description = Swap minds with the target. Either can change back after some time.
...
pyrokinesis-power-initialization-feedback =
    There is a brilliant flash of light and heat, and for an instant I feel as though every millimeter of my flesh is turned to vapor.
    Yet death does not come for me, though I find myself praying it does.
    The world beyond is both agonizingly hot and bone chilling.
    For weeks I despair that Gehenna is real, I starve, I cry, I scream, and the pain does not cease.
    Finally, a man in white, with the face of an ogrous fly beckons me to offer my service.
    When I reach out to shake his hand, the vision fades, and I find myself standing in the prime materium.
    I know his name now, it is the Secret of Fire.
    Merely by thinking of it, I can feel the heat of that place come to my hands.
...
telegnosis-power-initialization-feedback =
    With my next step, I find that I am no longer in the material realm.
    My feet are trodding upon a bridge of rainbow light.
    Yet strangly, as I look left and right, I first see a color that is as pink within pink, and to my right, blue within blue.
    Just as my mind reels from the displeasure of knowing colors that aren't, a creature I can only describe as a dragon with the wings of a peacock swoops down, and consumes my flesh in a single bite.
    I awaken in an instant, to a world utterly devoid of true, real colors.
...
psionic-invisibility-power-initialization-feedback =
    ...
    Pondering this, I arrive at a realization that sight itself is an illusion.
    I reject it, I deny that light itself is real.
