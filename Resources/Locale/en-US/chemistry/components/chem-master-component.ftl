...
chem-master-window-sort-method-Alphabetical-text = Alphabetical
chem-master-window-sort-method-Amount-text = Highest Amount
chem-master-window-transferring-label = Transferring: {$quantity}
chem-master-window-transferring-default-label = Transferring: 50
