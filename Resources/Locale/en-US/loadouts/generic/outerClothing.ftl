...
loadout-name-LoadoutOuterCardigan = cardigan (colorable)
loadout-name-LoadoutOuterCardiganOpened = cardigan, opened (colorable)
...
loadout-name-LoadoutOuterBlazer = blazer (colorable)
loadout-name-LoadoutOuterBlazerOpened = blazer, opened (colorable)
