trait-name-Dockta = Imperial Creole
trait-description-Dockta = A language developed by the Union over time; a mishmash of Low Imperial with other languages, integrated to be used with aggressive hand gestures to communicate with others in zero-atmosphere, zero-gravity space.
