language-Dockta-name = Dockworker's Canto
language-Dockta-description = A language developed by the Union over time; a mishmash of most known languages, integrated to be used with aggressive hand gestures to communicate with others in zero-atmosphere, zero-gravity space.
chat-language-Dockta-name = Dockworker's Canto
