book-accelerated-conscript-training-manual1 =
        ...
        █ [bold]{part 1/2}[/bold]
        ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
        [bold]This is a classified document issued by the New Crescent Worker’s League (NCWL) if found elsewhere report it immediately for invesitagion.[/bold]

        [head=2]Chapter 0: Introduction[/head]

        Welcome to the communard comrade!
        ...
        [head=2]Chapter 1: Basic survival[/head]

        Before even thinking of leaving the safety of Port Balreska make sure you obtain everything from the following list.
        Communard statistics suggest missing any item drastically lowers your life expectancy. [bold]
        ...
        If you are missing any of the items contact your nearest officer or comrade for help.[/bold]

        [head=3]Chapter 1.1: Communication[/head]

        The following channels are avaliable to you.
        [bold]
        1. ’:o’ for faction communication.
        2. ’:d’ for close range general communication (500m).
        3. ’;’ for long range general communication (2.5km).[/bold]

        NCWL’s official language is Crescent Creole if you hear a communard member speaking anything else report them to command.

        [head=2]Chapter 2: Standard Operating Procedures[/head]
        ...
        3. A grand fleet, built by the hands of workers, will destroy enemies of the communard.[/bold]

        If you are unsure as of to your role or have any question find your nearest officer. The communard always needs a pair of hands.
        If you suspect your comrade of avoiding work report them to your superiors.

        [head=3]Chapter 2.1: Basic Ship Operation[/head]
        ...
        6. Signal using secure communications that you are ready. Be sure to include your ship model and number.[/bold]

        [head=3]Chapter 2.2 Pilot Doctrine[/head]
        ...
        4. Follow orders and dont split formation.[/bold]
        ...
        [head=3]Chapter 2.3 Gunnery Doctrine[/head]
        ...
        [head=3]Chapter 2.4 Loading Doctrine[/head]
...
book-accelerated-conscript-training-manual2 =
        ...
        █ [bold]{part 2/2}[/bold]
        ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
        [bold]Attention! Only proceed after reading part 1![/bold]

        [head=3]Chapter 2.5 Mining basics[/head]
        ...
        [head=2]Chapter 3 Emergency Procedures[/head]
        ...
        [head=3]Chapter 3.1 Emergency Ship Repairs[/head]
        ...
        4. Power (See Emergency Power Repairs)[/bold]
        ...
        [head=3]Chapter 3.2 Emergency Power Repairs[/head]
        ...
        Generators can be switched to operate on MV if your substation is destroyed. [/bold]

        [head=3]Chapter 3.3 Emergency Bailing[/head]
        ...
        4. Not having sufficient air supplies.[/bold]
        ...
        [head=3]Chapter 3.3 Boarder Defense[/head]
