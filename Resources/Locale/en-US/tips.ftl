...
tips-dataset-142 = The reverse engineering machine can't reverse engineer blood red hardsuits.
tips-dataset-143 = If you have the CPR Training trait, or are any medical doctor, you can perform CPR by right clicking someone who is dead or in critical condition.
tips-dataset-144 = CPR can occasionally 'defib' dead patients back to critical.
tips-dataset-145 = Performing CPR on a dead patient will reduce their rot timer, allowing doctors more time to save a patient.
tips-dataset-146 = Bibles, holy water, and the anti-psychic knife can deal holy damage, which has strong effects against some creatures.
tips-dataset-147 = Ectoplasm is used in the recipe for normality crystals.
tips-dataset-148 = As a Security Officer, if you're not sure how to determine the severity of a crime or the appropriate punishment, take a look at the Crime Assist application in your PDA!
tips-dataset-149 = If you do not take the Latent Psychic trait, you can never be psionic. There may however exist some unusual conditions that can grant this trait during a round.
tips-dataset-150 = The kitchen Deep Fryer is the most powerful machine ever created by man. It is not merely limited to deep frying food, but can deep fry almost ANYTHING that will fit in the basket. Try deep frying the captain's spare ID!
tips-dataset-151 = If you see a security officer roaming with his stun baton or gun out on green, you have a moral obligation to steal his baton and feed it to the Deep Fryer.
tips-dataset-152 = Harpies have the ability to imitate several different instruments, and can 'Sing' by opening an innate midi player.
tips-dataset-153 = You can see if a Harpy is singing by looking for the musical notes floating around their head.
tips-dataset-154 = Talking mimes are not legally considered people, and should be killed on sight for their crimes against the mime gods.
tips-dataset-155 = You can pick up another person by holding Alt, and left clicking on the person. Your ability to carry them is determined by your relative size!
tips-dataset-156 = Your character's size affects many things in the game, some of which you might not have been aware of. Larger characters experience less gun recoil. Smaller characters can slip handcuffs faster.
tips-dataset-157 = 'Space Wind' is the term for how flowing air can throw objects or people. A hull breach is typically the most common cause of Space Wind, but it can also be caused by high pressure cannons!
tips-dataset-158 = Ignore firelock warnings at your own peril. You may find yourself being violently thrown into deep space as soon as you crowbar the firelock open.
tips-dataset-159 = Your character's Mass determines how resistant they are to being thrown by space wind. A small Felinid or Harpy is easily ejected into space, while an Oni or Diona is usually unaffected.
tips-dataset-160 = Supermatter engines can be activated and powered by throwing objects into the crystal. Consider using the Clown to activate your station's Supermatter engine.
tips-dataset-161 = There is no friction in space. Unless you use Newton's 1st Law to save yourself, your corpse will float away from the station forever.
tips-dataset-162 = Cloning patients come out of the pod with extremely heavy Cellular damage. Consider using Doxarubixadone in a Cryo tube as an affordable means of 'Finishing' clones.
tips-dataset-163 = Your character's Mood stat influences both your movement speed, and critical injury threshold.
tips-dataset-164 = The Sanguine trait grants your character a permanent large mood bonus. As a result, they often move faster than other people, and will rarely ever take penalties from a net negative mood.
tips-dataset-165 = The Saturnine trait gives your character a permanent large mood penalty. As a result, they often move slower than other people, and can have a hard time getting a net positive mood.
tips-dataset-166 = If you aren't playing any Medical character, consider taking the CPR Training trait! This often highly-underrated trait allows characters to sometimes revive other people without needing medical supplies.
tips-dataset-167 = If you have the Latent Psychic trait, you can consume hallucinogenic drugs to have a chance to obtain psychic powers.
tips-dataset-168 = Having the Natural Telepath trait, or rolling the Telepathy Power, allows a person to speak telepathically by starting a message with '='. Telepathy does not require a radio, but is also completely anonymous.
tips-dataset-169 = Certain crew members, such as the Mystagogue, Cataloguer, and Psionic Mantis, all automatically start with certain Psychic Powers.
tips-dataset-170 = NanoTrasen prefers to select its command staff for high psychic potential. Thus, all command staff are inherently more likely to obtain Psychic Powers should they also have the Latent Psychic trait.
tips-dataset-171 = You can craft a tinfoil hat out of sheet metal. Wearing a tinfoil hat provides temporary protection from Psychic Powers! Beware, that it also disrupts the powers of any Psion who wears one.
tips-dataset-172 = You can press the R key to lay down on the ground. While Laying down, you can crawl underneath certain objects. Additionally, bullets will pass harmlessly over someone laying down, unless the shooter targets them directly.
