...
public sealed partial class CreditsWindow : DefaultWindow
{
    ...
    private void PopulatePatrons(BoxContainer patronsContainer)
    {
        ...
        {
            if (!first)
                patronsContainer.AddChild(new() { MinSize = new(0, 10), });
    ...
    private void PopulateContributors(BoxContainer ss14ContributorsContainer)
    {
        ...
        ss14ContributorsContainer.AddChild(
            new BoxContainer
            {
                ...
                Children =
                {
                    ...
                    (contributeButton = new() { Text = Loc.GetString("credits-window-contribute-button"), })
                }
            });
        ...
        {
            if (!first)
                ss14ContributorsContainer.AddChild(new() { MinSize = new(0, 10), });
