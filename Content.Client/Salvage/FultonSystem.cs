...
public sealed class FultonSystem : SharedFultonSystem
{
    ...
    private static readonly Animation InitialAnimation = new()
    {
        ...
        AnimationTracks =
        {
            new AnimationTrackSpriteFlick
            {
                ...
                KeyFrames =
                {
                    new(new("fulton_expand"), 0f),
                    new(new("fulton_balloon"), 0.4f)
                }
            }
        }
    };
    ...
    private static readonly Animation FultonAnimation = new()
    {
        ...
        AnimationTracks =
        {
            new AnimationTrackComponentProperty
            {
                ...
                {
                    new(Vector2.Zero, 0f),
                    new(new Vector2(0f, -0.3f), 0.3f),
                    new(new Vector2(0f, 20f), 0.5f)
                }
            }
        }
    };
    ...
    private void OnFultonMessage(FultonAnimationMessage ev)
    {
        ...
        var effectLayer = sprite.AddLayer(
            new SpriteSpecifier.Rsi(new("Objects/Tools/fulton_balloon.rsi"), "fulton_balloon"));
