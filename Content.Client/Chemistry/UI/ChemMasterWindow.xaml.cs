        ...
        else
        {
            ...
            foreach (var (name, id, quantity) in contents)
            {
                ...
                if (addReagentButtons)
                {
                    ...
                    // Padding
                    cs.Add(new() { HorizontalExpand = true, });
