...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        UIScaleOption.AddItem(
            Loc.GetString(
                "ui-options-scale-auto",
    ...
    private bool ConfigIsFullscreen => _cfg.GetCVar(CVars.DisplayWindowMode) == (int) WindowMode.Fullscreen;

    public void UpdateProperties() => FullscreenCheckBox.Pressed = ConfigIsFullscreen;
    ...
    private void UpdateViewportScale()
    {
        ...
        ViewportWidthSlider.Visible = ViewportWidthSliderDisplay.Visible = !ViewportStretchCheckBox.Pressed ||
            ViewportStretchCheckBox.Pressed && !ViewportVerticalFitCheckBox.Pressed;
    ...
    private void UpdateViewportWidthDisplay() =>
        ViewportWidthSliderDisplay.Text = Loc.GetString(
            "ui-options-vp-width",
            ("width", (int) ViewportWidthSlider.Value));
}
