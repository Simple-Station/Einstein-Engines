...
public sealed partial class KeyRebindTab : Control
{
    ...
    public KeyRebindTab()
    {
        ...
        {
            if (!first)
                KeybindsContainer.AddChild(new() { MinSize = new(0, 8), });
    ...
    private sealed class KeyControl : Control
    {
        ...
        public KeyControl(KeyRebindTab parent, BoundKeyFunction function)
        {
            ...
            BindButton1 = new(parent, this, StyleBase.ButtonOpenRight);
            BindButton2 = new(parent, this, StyleBase.ButtonOpenLeft);
            ResetButton = new()
