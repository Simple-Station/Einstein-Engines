...
[RegisterComponent, Access(typeof(ParticleAcceleratorPartVisualizerSystem)),]
public sealed partial class ParticleAcceleratorPartVisualsComponent : Component
{
    [DataField("stateBase", required: true), ViewVariables(VVAccess.ReadWrite),]
    public string StateBase = default!;

    [DataField("stateSuffixes"), ViewVariables(VVAccess.ReadWrite),]
