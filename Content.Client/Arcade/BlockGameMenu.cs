...
public sealed class BlockGameMenu : DefaultWindow
{
    ...
    public BlockGameMenu(BlockGameBoundUserInterface owner)
    {
        ...
        pauseMenuContainer.AddChild(new() { MinSize = new(1, 10), });

        _scoreBoardButton = new()
        {
        ...
        _unpauseButtonMargin = new() { MinSize = new(1, 10), Visible = false, };
        ...
        gameOverMenuContainer.AddChild(new() { MinSize = new(1, 10), });


        _finalScoreLabel = new() { Align = Label.AlignMode.Center, };
        gameOverMenuContainer.AddChild(_finalScoreLabel);
        gameOverMenuContainer.AddChild(new() { MinSize = new(1, 10), });

        _finalNewGameButton = new()
        {
            Text = Loc.GetString("blockgame-menu-button-new-game"),
            TextAlign = Label.AlignMode.Center
        };
        ...
        menuContainer.AddChild(new() { MinSize = new(1, 10), });
        ...
        _localHighscoresLabel = new()
        {
            Align = Label.AlignMode.Center
        };
        highScoreBox.AddChild(_localHighscoresLabel);
        highScoreBox.AddChild(new() { MinSize = new(40, 1), });
        _globalHighscoresLabel = new()
        {
            Align = Label.AlignMode.Center
        };
    ...
    private void TryPause() => _owner.SendAction(BlockGamePlayerAction.Pause);
