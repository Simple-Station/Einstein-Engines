...
public sealed partial class NewsWriterMenu : FancyWindow
{
    ...
    protected override void Resized()
    {
        ...
        ArticleEditorPanel.Margin = new(Width - 1, margin.Top, margin.Right, margin.Bottom);
    }
    ...
    private void OnCreate(BaseButton.ButtonEventArgs buttonEventArgs) => ArticleEditorPanel.Visible = true;
}
