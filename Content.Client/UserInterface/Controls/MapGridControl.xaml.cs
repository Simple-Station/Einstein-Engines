...
public partial class MapGridControl : LayoutContainer
{
    ...
    protected void DrawNoSignal(DrawingHandleScreen handle)
    {
        ...
        for (var i = 0; i < lineCount; i++)
        {
            ...
            var start = MidPointVector + angle.RotateVec(new(0f, 2.5f * distance / 4f));
            var end = MidPointVector + angle.RotateVec(new(0f, 4f * distance / 4f));
