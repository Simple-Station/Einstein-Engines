...
public sealed partial class CrimeAssistUiFragment : BoxContainer
{
    ...
    private readonly List<CrimeAssistPage>? _pages;
    ...
    public CrimeAssistUiFragment()
    {
        ...
        _pages = new(_prototypeManager.EnumeratePrototypes<CrimeAssistPage>());
    ...
    {
        _currentPage = page;
        var isResult = page.LocKeyPunishment != null;
        ...
        if (!isResult)
        {
            ...
            {
                var sophontExplanation = Loc.GetString("crime-assist-sophont-explanation");
        ...
        {
            var color = page.LocKeySeverity! switch
            {
    ...
    private CrimeAssistPage FindPageById(string id) => _pages?.Find(o => o.ID == id)!;
}
