...
public sealed class FootPrintsVisualizerSystem : VisualizerSystem<FootPrintComponent>
{
    ...
    private void UpdateAppearance(EntityUid uid, FootPrintComponent component, SpriteComponent sprite)
    {
        if (!sprite.LayerMapTryGet(FootPrintVisualLayers.Print, out var layer)
            ...
            || !_appearance.TryGetData<FootPrintVisuals>(
                uid,
                FootPrintVisualState.State,
                out var printVisuals,
                appearance))
            return;
        ...
        sprite.LayerSetState(
            ...
            new(
                printVisuals switch
                {
                    FootPrintVisuals.BareFootPrint => printsComponent.RightStep
                        ? printsComponent.RightBarePrint
                        : printsComponent.LeftBarePrint,
