...
public sealed partial class SmesComponent : Component
{
    ...
    /// </summary>
    [DataField("chargeOverlayPrefix"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("inputOverlayPrefix"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("outputOverlayPrefix"), ViewVariables(VVAccess.ReadWrite),]
