...
public sealed partial class PowerMonitoringWindow : FancyWindow
{
    ...
    {
        {
            ...
            (new(new("/Textures/Interface/NavMap/beveled_circle.png")), Color.Purple)
        },
        {
            PowerMonitoringConsoleGroup.SMES,
            (new(new("/Textures/Interface/NavMap/beveled_hexagon.png")), Color.OrangeRed)
        },
        {
            PowerMonitoringConsoleGroup.Substation,
            (new(new("/Textures/Interface/NavMap/beveled_square.png")), Color.Yellow)
        },
        {
            PowerMonitoringConsoleGroup.APC,
            (new(new("/Textures/Interface/NavMap/beveled_triangle.png")), Color.LimeGreen)
        }
    };
    ...
    )
    {
        ...
        TotalBatteryUsage.FontColorOverride = totalSources * 0.1111f < totalBatteryUsage ? new(180, 0, 0) : Color.White;
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        SystemWarningPanel.Modulate = lit ? Color.White : new(178, 178, 178);
    }
