...
[RegisterComponent, Access(typeof(ApcVisualizerSystem)),]
public sealed partial class ApcVisualsComponent : Component
{
    ...
    /// </summary>
    [DataField("numLockIndicators"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("lockIndicatorPrefix"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("lockIndicatorSuffixes"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("numChannelIndicators"), ViewVariables(VVAccess.ReadWrite),]
    ...
    ///     Valid states are of the form \<BASE\>\<PREFIX\>\<IDX\>-\<STATE\>
    /// </summary>
    [DataField("channelIndicatorPrefix"), ViewVariables(VVAccess.ReadWrite),]
    ...
    ///     Valid states are of the form \<PREFIX\>\<IDX\>-\<STATE\>
    /// </summary>
    [DataField("channelIndicatorSuffixes"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("screenStatePrefix"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("screenStateSuffixes"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("screenColors"), ViewVariables(VVAccess.ReadWrite),]
    public Color[] ScreenColors = new Color[(byte) ApcChargeState.NumStates]
    {
        Color.FromHex("#d1332e"), Color.FromHex("#2e8ad1"), Color.FromHex("#3db83b"), Color.FromHex("#ffac1c")
    };

    /// <summary>
    ///     The sprite state of the unlit overlay used for the APC screen when the APC has been emagged.
    /// </summary>
    [DataField("emaggedScreenState"), ViewVariables(VVAccess.ReadWrite),]
    public string EmaggedScreenState = "emag-unlit";

    /// <summary>
    ///     The color of the light emitted when the APC has been emagged.
    /// </summary>
    [DataField("emaggedScreenColor"), ViewVariables(VVAccess.ReadWrite),]
