...
public sealed partial class GasAnalyzerWindow : DefaultWindow
{
    ...
    public void Populate(GasAnalyzerUserMessage msg)
    {
        ...
        if (msg.NodeGasMixes.Length == 0)
        {
            ...
            MinSize = new(CTopBox.DesiredSize.X + 40, MinSize.Y);
            return;
        }
        ...
        if (msg.NodeGasMixes.Length > 1)
        {
            ...
            if (msg.NodeGasMixes.Length == 2)
            {
                ...
                minSize = new(CDeviceGrid.DesiredSize.X + 40, MinSize.Y);
            }
            ...
            else
            {
                ...
                MiddlePanel.Visible = false;
                RightPanel.Visible = false;
                minSize = new(CDeviceMixes.DesiredSize.X + 40, MinSize.Y);
            }
        }
        else
        {
            ...
            minSize = new(CEnvironmentMix.DesiredSize.X + 40, MinSize.Y);
        }
    ...
    private void GenerateGasDisplay(GasMixEntry gasMix, Control parent)
    {
        var panel = new PanelContainer
        {
            ...
            Margin = new(4),
            PanelOverride = new StyleBoxFlat { BorderColor = Color.FromHex("#4f4f4f"), BorderThickness = new(1), }
        };
        var dataContainer = new BoxContainer
            { Orientation = BoxContainer.LayoutOrientation.Vertical, VerticalExpand = true, Margin = new(4), };
        ...
        for (var j = 0; j < gasMix.Gases.Length; j++)
        {
            ...
            tableVal.AddChild(
                ...
                {
                    Text = Loc.GetString(
                        "gas-analyzer-window-molarity-text",
                        ("mol", $"{gas.Amount:0.00}")),
                    Align = Label.AlignMode.Right
                });
            tablePercent.AddChild(
