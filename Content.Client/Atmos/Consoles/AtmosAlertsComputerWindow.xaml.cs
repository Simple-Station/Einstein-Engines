...
public sealed partial class AtmosAlertsComputerWindow : FancyWindow
{
    ...
    )
    {
        ...
        _activeAlarms = _allAlarms.Where(
            x => x.AlarmState > AtmosAlarmType.Normal &&
        ...
        if (consoleCoords != null && consoleUid != null)
        {
            var texture = _spriteSystem.Frame0(
                new SpriteSpecifier.Texture(new("/Textures/Interface/NavMap/beveled_circle.png")));
        ...
        if (MasterTabContainer.CurrentTab == 0 && activeAlarmCount == 0)
        {
            ...
            label.SetMarkup(
                Loc.GetString(
                    ...
                    ("color", StyleNano.GoodGreenFore.ToHexNoAlpha())));
    ...
    )
    {
        ...
        if (index >= table.ChildCount)
        {
            ...
            newEntryContainer.SilenceCheckBox.OnToggled += _ => OnSilenceAlertsToggled(
                newEntryContainer.NetEntity,
                newEntryContainer.SilenceCheckBox.Pressed);
    ...
    private (SpriteSpecifier.Texture, Color)? GetBlipTexture(AtmosAlarmType alarmState)
    {
        ...
        switch (alarmState)
        {
            case AtmosAlarmType.Invalid:
                output = (new(new("/Textures/Interface/NavMap/beveled_circle.png")), StyleNano.DisabledFore);
                break;
            case AtmosAlarmType.Normal:
                output = (new(new("/Textures/Interface/NavMap/beveled_circle.png")), Color.LimeGreen);
                break;
            case AtmosAlarmType.Warning:
                output = (new(new("/Textures/Interface/NavMap/beveled_triangle.png")), new(255, 182, 72));
                break;
            case AtmosAlarmType.Danger:
                output = (new(new("/Textures/Interface/NavMap/beveled_square.png")), new(255, 67, 67));
                break;
        }
