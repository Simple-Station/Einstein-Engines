...
/// <summary>
///     This class presents the Construction/Crafting UI to the client, linking the <see cref="ConstructionSystem" /> with
///     the
///     model. This is where the bulk of UI work is done, either calling functions in the model to change state, or
///     collecting
...
internal sealed class ConstructionMenuPresenter : IDisposable
{
    ...
    public void OnHudCraftingButtonToggled(ButtonToggledEventArgs args) => WindowOpen = args.Pressed;
