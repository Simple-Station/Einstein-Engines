...
public sealed class AmbientSoundSystem : SharedAmbientSoundSystem
{
    ...
    private static readonly AudioParams _params = AudioParams.Default
        .WithVariation(0.01f)
        .WithLoop(true)
        .WithMaxDistance(7f);
    ...
    private readonly Dictionary<AmbientSoundComponent, (EntityUid? Stream, SoundSpecifier Sound, string Path)>
        _playingSounds = new();
    ...
    public bool OverlayEnabled
    {
        ...
        set
        {
            ...
            if (_overlayEnabled)
            {
                _overlay = new(EntityManager, this, EntityManager.System<EntityLookupSystem>());
