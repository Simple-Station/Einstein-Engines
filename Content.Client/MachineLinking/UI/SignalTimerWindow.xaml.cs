...
public sealed partial class SignalTimerWindow : DefaultWindow
{
    ...
    public void SetCurrentDelayMinutes(string delay) => CurrentDelayEditMinutes.Text = delay;

    public void SetCurrentDelaySeconds(string delay) => CurrentDelayEditSeconds.Text = delay;
