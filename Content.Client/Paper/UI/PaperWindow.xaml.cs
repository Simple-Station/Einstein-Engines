...
public sealed partial class PaperWindow : BaseWindow
{
    ...
    public void InitVisuals(EntityUid entity, PaperVisualsComponent visuals)
    {
        ...
        var backgroundImage = visuals.BackgroundImagePath != null
            ? resCache.GetResource<TextureResource>(visuals.BackgroundImagePath)
            : null;
        ...
        var contentImage = visuals.ContentImagePath != null
            ? resCache.GetResource<TextureResource>(visuals.ContentImagePath)
            : null;
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        if (WrittenTextLabel.TryGetStyleProperty<Font>("font", out var font))
        {
            ...
            _paperContentTex.TextureScale = new(1, scaleY);
            ...
            // text to be offset from a line)
            {
                ...
                TextAlignmentPadding.Margin = new(0.0f, verticalMargin, 0.0f, 0.0f);
            }
        }
    ...
    {
        var isEditing = state.Mode == SharedPaperComponent.PaperAction.Write;
        ...
        foreach (var stamper in state.StampedBy)
            StampDisplay.AddStamp(new() { StampInfo = stamper, });
    }
    ...
    private void RunOnSaved() => OnSaved?.Invoke(Rope.Collapse(Input.TextRope));
}
