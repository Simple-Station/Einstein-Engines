...
[RegisterComponent, Access(typeof(PowerChargerVisualizerSystem)),]
public sealed partial class PowerChargerVisualsComponent : Component
{
    ...
    /// </summary>
    [DataField("emptyState"), ViewVariables(VVAccess.ReadWrite),]
    public string EmptyState = "empty";

    /// <summary>
    ///     The base sprite state used if the power cell charger contains a power cell.
    /// </summary>
    [DataField("occupiedState"), ViewVariables(VVAccess.ReadWrite),]
    ...
    ///     <see cref="CellChargerStatus.Charged" /> Maps to the state used when the charger contains a fully charged power
    ///     cell.
    /// </summary>
    [DataField("lightStates"), ViewVariables(VVAccess.ReadWrite),]
