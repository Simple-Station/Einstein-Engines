...
public sealed class ClientInventorySystem : InventorySystem
{
    ...
    public void SetSlotHighlight(EntityUid owner, InventorySlotsComponent component, string slotName, bool state)
    {
        ...
        var newData = component.SlotData[slotName] = new(oldData, state);
    ...
    )
    {
        ...
        var newData = component.SlotData[slotName] =
            new(component.SlotData[slotName], newHighlight, newBlocked);
        if (owner == _playerManager.LocalEntity)
            EntitySlotUpdate?.Invoke(newData);
    }
    ...
    public void OnRefreshInventorySlots(
        EntityUid owner,
        InventorySlotsComponent component,
        RefreshInventorySlotsEvent args
    )
    {
    ...
    public void UIInventoryActivate(string slot) => EntityManager.RaisePredictiveEvent(new UseSlotNetworkMessage(slot));
    ...
    public void UIInventoryActivateItem(string slot, EntityUid uid)
    {
        ...
        EntityManager.RaisePredictiveEvent(
            new InteractInventorySlotEvent(GetNetEntity(item.Value)));
    }
    ...
    public void UIInventoryAltActivateItem(string slot, EntityUid uid)
    {
        ...
        EntityManager.RaisePredictiveEvent(new InteractInventorySlotEvent(GetNetEntity(item.Value), true));
    }
