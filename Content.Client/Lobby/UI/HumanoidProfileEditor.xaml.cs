...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            MarkingManager markings)
        {
            ...
            RgbSkinColorContainer.AddChild(RgbSkinColorSelector = new ColorSelectorSliders());
            RgbSkinColorSelector.OnColorChanged += _ => { OnSkinColorOnValueChanged(); };
            ...
            ClothingButton.AddItem(Loc.GetString("humanoid-profile-editor-preference-jumpsuit"), (int) ClothingPreference.Jumpsuit);
            ClothingButton.AddItem(Loc.GetString("humanoid-profile-editor-preference-jumpskirt"), (int) ClothingPreference.Jumpskirt);
            ...
            BackpackButton.AddItem(Loc.GetString("humanoid-profile-editor-preference-backpack"), (int) BackpackPreference.Backpack);
            BackpackButton.AddItem(Loc.GetString("humanoid-profile-editor-preference-satchel"), (int) BackpackPreference.Satchel);
            BackpackButton.AddItem(Loc.GetString("humanoid-profile-editor-preference-duffelbag"), (int) BackpackPreference.Duffelbag);
                ...
                foreach (var job in jobs)
                {
                    ...
                    selector.OnSelected += priority =>
                    {
                        foreach (var (jobId, other) in _jobPriorities)
                        {
                            ...
                            else if (selectedPrio == JobPriority.High && (JobPriority) other.Selected == JobPriority.High)
                            {
        ...
        private void OnSkinColorOnValueChanged()
        {
            ...
            switch (skin)
            {
                ...
                case HumanoidSkinColor.Hues:
                {
                    ...
                    Markings.CurrentSkinColor = RgbSkinColorSelector.Color;
                    Profile = Profile.WithCharacterAppearance(Profile.Appearance.WithSkinColor(RgbSkinColorSelector.Color));
                    break;
                }
                ...
                case HumanoidSkinColor.TintedHuesSkin: // DeltaV - Tone blending
                {
                    ...
                    {
                        HumanoidSkinColor.TintedHues => SkinColor.TintedHues(RgbSkinColorSelector.Color),
                        HumanoidSkinColor.TintedHuesSkin => SkinColor.TintedHuesSkin(RgbSkinColorSelector.Color, skinColor),
                        _ => Color.White
                    };
                ...
                case HumanoidSkinColor.VoxFeathers:
                {
                    ...
                    var color = SkinColor.ClosestVoxColor(RgbSkinColorSelector.Color);
        ...
        private void UpdateSkinColor()
        {
            ...
            switch (skin)
            {
                ...
                case HumanoidSkinColor.Hues:
                {
                    ...
                    RgbSkinColorSelector.Color = Profile.Appearance.SkinColor;
                    break;
                }
                case HumanoidSkinColor.TintedHues:
                {
                ...
                case HumanoidSkinColor.VoxFeathers:
                {
                    ...
                    RgbSkinColorSelector.Color = SkinColor.ClosestVoxColor(Profile.Appearance.SkinColor);
        ...
        private void UpdateGenderControls()
        {
            ...
            PronounButton.SelectId((int) Profile.Gender);
        }
