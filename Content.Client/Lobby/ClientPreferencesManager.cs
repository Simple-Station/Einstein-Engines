...
public sealed class ClientPreferencesManager : IClientPreferencesManager
{
    ...
    {
        Preferences = new(Preferences.Characters, slot, Preferences.AdminOOCColor);
    ...
    public void UpdateCharacter(ICharacterProfile profile, int slot)
    {
        ...
        Preferences = new(characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor);
