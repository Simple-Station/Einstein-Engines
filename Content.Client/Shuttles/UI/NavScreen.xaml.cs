...
public sealed partial class NavScreen : BoxContainer
{
    ...
    public void UpdateState(NavInterfaceState scc) => NavRadar.UpdateState(scc);
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        GridLinearVelocity.Text =
            $"{gridVelocity.X + 10f * float.Epsilon:0.0}, {gridVelocity.Y + 10f * float.Epsilon:0.0}";
