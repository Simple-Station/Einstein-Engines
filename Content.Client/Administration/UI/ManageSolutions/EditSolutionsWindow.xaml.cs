...
/// <summary>
///     A simple window that displays solutions and their contained reagents. Allows you to edit the reagent quantities and
///     add new reagents.
/// </summary>
...
public sealed partial class EditSolutionsWindow : DefaultWindow
{
    ...
    private void UpdateThermalBox(Solution solution)
    {
        ...
        specificHeatLabel.Margin = new(0, 1);
        ...
        heatCapacityLabel.Margin = new(0, 1);
        ...
        temperatureSpin.Margin = new(0, 1);
        ...
        thermalEnergySpin.Margin = new(0, 1);
    ...
    private void OpenAddReagentWindow(BaseButton.ButtonEventArgs obj)
    {
        ...
        _addReagentWindow = new(_target, _selectedSolution);
