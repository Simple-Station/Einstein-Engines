...
public sealed partial class AdminMessagePopupWindow : Control
{
    ...
    public AdminMessagePopupWindow()
    {
        ...
        Robust.Client.UserInterface.Stylesheet = IoCManager.Resolve<IStylesheetManager>().SheetSpace;
    ...
    {
        Robust.Shared.Timing.Timer = (float) state.Time.TotalSeconds;
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (Robust.Shared.Timing.Timer > 0.0)
        {
            if (Robust.Shared.Timing.Timer - args.DeltaSeconds < 0)
                Robust.Shared.Timing.Timer = 0;
            else
                Robust.Shared.Timing.Timer -= args.DeltaSeconds;
        }
        else
        {
