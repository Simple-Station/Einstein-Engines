...
public sealed class VendingMachineBoundUserInterface : BoundUserInterface
{
    ...
    protected override void Open()
    {
        ...
        _menu = new() { Title = EntMan.GetComponent<MetaDataComponent>(Owner).EntityName, };
    ...
    private void OnSearchChanged(string? filter) => _menu?.Populate(_cachedInventory, out _cachedFilteredIndex, filter);
}
