...
public sealed partial class HealthAnalyzerWindow : FancyWindow
{
    ...
    public void Populate(HealthAnalyzerScannedUserMessage msg)
    {
        ...
        SpeciesLabel.Text =
            _entityManager.TryGetComponent<HumanoidAppearanceComponent>(
                _target.Value,
    ...
    private EntityUid? SetupIcon(Dictionary<TargetBodyPart, TargetIntegrity>? body)
    {
        ...
        foreach (var (bodyPart, integrity) in body)
        {
            ...
            sprite.LayerSetScale(layer, new(3f, 3f));
            layer++;
        }
