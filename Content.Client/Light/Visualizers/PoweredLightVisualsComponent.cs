...
[RegisterComponent, Access(typeof(PoweredLightVisualizerSystem)),]
public sealed partial class PoweredLightVisualsComponent : Component
{
    ...
    /// </summary>
    [DataField("spriteStateMap"), ViewVariables(VVAccess.ReadOnly),]
    ...
    /// </summary>
    [DataField("minBlinkingTime"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("maxBlinkingTime"), ViewVariables(VVAccess.ReadWrite),]
    public float MaxBlinkingAnimationCycleTime = 2;

    /// <summary>
    ///     The sound that plays when the blinking animation cycles.
    /// </summary>
    [DataField("blinkingSound"), ViewVariables(VVAccess.ReadWrite),]
