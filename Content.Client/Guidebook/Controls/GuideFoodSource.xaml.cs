...
public sealed partial class GuideFoodSource : BoxContainer, ISearchableControl
{
    ...
    private void GenerateControl(FoodButcheringData entry)
    {
        ...
        ProcessingTexture.TexturePath = "/Textures/Objects/Weapons/Melee/kitchen_knife.rsi/icon.png"; // all hardcoded because eugh
    }
    ...
    private void GenerateControl(FoodRecipeData entry)
    {
        ...
        ProcessingTexture.TexturePath = "/Textures/Structures/Machines/microwave.rsi/mw.png";
    ...
    {
        if (ent.TryGetComponent<IconComponent>(out var icon))
        {
            texture = _sprites.GetIcon(icon);
            return true;
        }
