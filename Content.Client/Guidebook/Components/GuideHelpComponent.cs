...
/// </summary>
[RegisterComponent, Access(typeof(GuidebookSystem)),]
public sealed partial class GuideHelpComponent : Component
{
    ...
    /// </summary>
    [DataField("includeChildren"), ViewVariables(VVAccess.ReadWrite),]
    ...
    /// </summary>
    [DataField("openOnActivation"), ViewVariables(VVAccess.ReadWrite),]
