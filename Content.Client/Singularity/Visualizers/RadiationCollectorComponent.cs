...
/// </summary>
[RegisterComponent, Access(typeof(RadiationCollectorSystem)),]
public sealed partial class RadiationCollectorComponent : Component
{
    ...
    /// <summary>
    ///     The RSI state used for the main sprite layer (<see cref="RadiationCollectorVisualLayers.Main" />) when the
    ///     radiation collector is active.
    /// </summary>
    [DataField("activeState"), ViewVariables(VVAccess.ReadWrite),]
    public string ActiveState = "ca_on";

    /// <summary>
    ///     The RSI state used for the main sprite layer (<see cref="RadiationCollectorVisualLayers.Main" />) when the
    ///     radiation collector is inactive.
    /// </summary>
    [DataField("inactiveState"), ViewVariables(VVAccess.ReadWrite),]
