...
public sealed class HandsSystem : SharedHandsSystem
{
    ...
    public EntityUid? GetActiveHandEntity() => TryGetPlayerHands(out var hands) ? hands.ActiveHandEntity : null;
    ...
    {
        if (part.Comp.PartType != BodyPartType.Hand || !Resolve(uid, ref sprite, false))
            return;
