...
[RegisterComponent, Access(typeof(EntityStorageVisualizerSystem)),]
public sealed partial class EntityStorageVisualsComponent : Component
{
    ...
    /// </summary>
    [DataField("stateBaseClosed"), ViewVariables(VVAccess.ReadWrite),]
