...
public sealed partial class IconSmoothSystem : EntitySystem
{
            ...
            || !smooth.Running)
        {
                ...
                xformQuery.TryGetComponent(uid, out xform))
            {
                ...
                if (TryComp(xform.GridUid, out grid))
                {
                    ...
                    if (MatchingEntity(
                        smooth,
                        grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.South)),
                        smoothQuery))
                    ...
                    if (MatchingEntity(
                        smooth,
                        grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.West)),
                        smoothQuery))
    ...
    )
    {
        ...
        for (var i = 0; i < neighbors.Length; i++)
        {
            ...
            matching = matching && MatchingEntity(
                smooth,
                grid.GetAnchoredEntitiesEnumerator(pos + neighbor),
                smoothQuery);
        }
    ...
    )
    {
        ...
        var ne = MatchingEntity(
            smooth,
            grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.NorthEast)),
            smoothQuery);
        ...
        var se = MatchingEntity(
            smooth,
            grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.SouthEast)),
            smoothQuery);
        ...
        var sw = MatchingEntity(
            smooth,
            grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.SouthWest)),
            smoothQuery);
        ...
        var nw = MatchingEntity(
            smooth,
            grid.GetAnchoredEntitiesEnumerator(pos.Offset(Direction.NorthWest)),
            smoothQuery);
