...
public sealed class WiresMenu : BaseWindow
{
    ...
    public WiresMenu(WiresBoundUserInterface owner)
    {
        ...
        wrappingHBox.AddChild(new() { MinSize = new(20, 0), });
        ...
        helpButton.OnPressed += a =>
        {
            ...
            popup.Open(UIBox2.FromDimensions(a.Event.PointerLocation.Position, new(400, 200)));
        };
    ...
    private sealed class WireControl : Control
    {
        ...
        )
        {
            ...
            LayoutContainer.SetPosition(contact1, new(0, 0));
    ...
    private sealed class StatusLight : Control
    {
        private static readonly Animation _blinkingFast = new()
        {
            ...
            AnimationTracks =
            {
                new AnimationTrackControlProperty
                {
                    ...
                    {
                        new(Color.White, 0f),
                        new(Color.Transparent, 0.1f),
                        new(Color.White, 0.1f)
                    }
                }
            }
        };
        ...
        private static readonly Animation _blinkingSlow = new()
        {
            ...
            AnimationTracks =
            {
                new AnimationTrackControlProperty
                {
                    ...
                    {
                        new(Color.White, 0f),
                        new(Color.White, 0.3f),
                        new(Color.Transparent, 0.1f),
                        new(Color.Transparent, 0.3f),
                        new(Color.White, 0.1f)
                    }
                }
            }
        ...
        public StatusLight(StatusLightData data, IResourceCache resourceCache)
        {
            ...
            hBox.AddChild(new() { MinSize = new(6, 0), });
            AddChild(hBox);
        }
    }
