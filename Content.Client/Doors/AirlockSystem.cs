...
public sealed class AirlockSystem : SharedAirlockSystem
{
    ...
    private void OnComponentStartup(EntityUid uid, AirlockComponent comp, ComponentStartup args)
    {
        ...
        if (
            comp.OpenUnlitVisible) // Otherwise there are flashes of the fallback sprite between clicking on the door and the door closing animation starting.
        {
        ...
        ((Animation) door.OpeningAnimation).AnimationTracks.Add(
            new AnimationTrackSpriteFlick
            {
                ...
                KeyFrames = { new(comp.OpeningSpriteState, 0f), }
            }
        );
        ...
        ((Animation) door.ClosingAnimation).AnimationTracks.Add(
            ...
            {
                LayerKey = DoorVisualLayers.BaseUnlit,
                KeyFrames = { new(comp.ClosingSpriteState, 0f), }
            }
        );
        ...
        door.DenyingAnimation = new Animation
        {
            ...
            AnimationTracks =
            {
                ...
                {
                    LayerKey = DoorVisualLayers.BaseUnlit,
                    KeyFrames = { new(comp.DenySpriteState, 0f), }
                }
            }
        };
        ...
        ((Animation) door.OpeningAnimation).AnimationTracks.Add(
            new AnimationTrackSpriteFlick
            {
                ...
                KeyFrames = { new(comp.OpeningPanelSpriteState, 0f), }
            });
        ...
        ((Animation) door.ClosingAnimation).AnimationTracks.Add(
            ...
            {
                LayerKey = WiresVisualLayers.MaintenancePanel,
                KeyFrames = { new(comp.ClosingPanelSpriteState, 0f), }
            });
    }
    ...
    private void OnAppearanceChange(EntityUid uid, AirlockComponent comp, ref AppearanceChangeEvent args)
    {
        ...
        if (_appearanceSystem.TryGetData<bool>(uid, DoorVisuals.Powered, out var powered, args.Component) && powered)
        {
            ...
            emergencyLightsVisible = _appearanceSystem.TryGetData<bool>(
                uid,
