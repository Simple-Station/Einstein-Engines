...
public sealed class CommunicationsConsoleBoundUserInterface : BoundUserInterface
{
    ...
    public int Countdown =>
        _expectedCountdownTime == null
            ? 0
            : Math.Max((int) _expectedCountdownTime.Value.Subtract(_gameTiming.CurTime).TotalSeconds, 0);
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        AlertLevelSelectable = commsState.AlertLevels != null && !float.IsNaN(commsState.CurrentAlertDelay) &&
