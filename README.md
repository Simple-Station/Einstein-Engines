...
Space Station 14 is inspired heavily by Space Station 13 and runs on the [Supermatter Engine](https://github.com/Simple-Station/SupermatterEngine), a homegrown engine written in C#.
