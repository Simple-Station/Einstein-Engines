...
namespace Content.Server.Ghost.Roles
{
    ...
    public sealed partial class GhostRoleSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<GhostRoleCharacterSpawnerComponent, TakeGhostRoleEvent>(OnSpawnerTakeCharacter); // - Character ghost roles, see Content.Server/Ghost/Roles/GhostRoleSystem.Character.cs
