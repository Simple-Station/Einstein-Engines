...
<<<<<<< HEAD:Content.Server/Backmen/Blob/BlobCoreSystem.cs
                observer.Value,
||||||| parent of 3c3173a51d ([Tweak] Blob Things (#963)):Content.Server/Backmen/Blob/BlobCoreSystem.cs
                observer.Value,
                observer.Value,
=======
                coordinates.Value,
                observer.Value,
>>>>>>> 3c3173a51d ([Tweak] Blob Things (#963)):Content.Server/Backmen/Blob/Systems/BlobCoreSystem.cs
                PopupType.Large);
            return false;
        }
