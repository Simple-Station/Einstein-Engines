...
{
    public sealed class FlightSystem : EntitySystem
    {
        ...
        [Dependency] private readonly FloatingVisualizerSystem _floatSystem = default!;
...
/*
        ...
        */
        ...
        {
            _flightSystem.ToggleActive(!component.On, component);
            Dirty(uid, component);
            if (TryComp<FloatingVisualsComponent>(uid, out var floating))
            {
                _floatSystem.FloatAnimation(uid, floating.Offset, floating.AnimationKey, floating.AnimationTime, component.On);
            }
        }
